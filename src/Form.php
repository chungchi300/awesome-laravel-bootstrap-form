...
HTML;
  ...
  <div class="form-group select-form-group label-static">
...
HTML;
     ...
     * @return string
     */
    public function formSelect($fieldName,$label='',$options,$val,$placeholder='',$attributes=[]){
        $helpblock = (array_key_exists('helpblock',$attributes) ? $attributes['helpblock'] : "");
...
HTML;
    ...
    public function formTextarea($name,$label,$placeHolder,$attributes=[]){

        $helpblock = (array_key_exists('helpblock',$attributes) ? $attributes['helpblock'] : "");
        $attributes['placeholder'] = $placeHolder;
        $field =   $this->textarea($name,null,$attributes);
        return <<<HTML
...
HTML;
    ...
    public function formText($name,$label,$placeHolder,$attributes=[]){

        $helpblock = (array_key_exists('helpblock',$attributes) ? $attributes['helpblock'] : "");
        $attributes['placeholder'] = $placeHolder;
        $field =   $this->text($name,null,$attributes);
        return <<<HTML
...
HTML;
     ...
     * @return string
     */
    public function formNumber($name,$label,$placeHolder,$attributes=[]){

        $helpblock = (array_key_exists('helpblock',$attributes) ? $attributes['helpblock'] : "");
        $attributes['placeholder'] = $placeHolder;
        $field =   $this->number($name,null,$attributes);
        return <<<HTML
